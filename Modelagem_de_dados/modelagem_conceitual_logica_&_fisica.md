...
Modelagem Conceitual:
    ...
    - Quanto mais alto nível, mais facíl a compreensão dos conceitos, quanto mais baixo o nível, mais 
    facil das maquinas entenderem.
    ...
    Parte gráfica. Analisar a imagem conceitual1.png
...
Modelo Lógico
    ...
    - NEsse modelo pode-se definir a tecnologia utilizada para a armazenagem dos dados, por exemplo ou o banco de dados relacionais
    ou não relacionais.
    Formas de representação de um modelo logico:
        - Observar imagem modelo_logico1.png. Nessa forma temos basicamente a definiçao dos nomes de tabela,
        colunas e exemplificação dos dados que serão armazenados.
        Além disso conseguimos observar o tipo dos dados, por exemplo pode-se observar que código será um tipo inteiro e o campo 
        Descrição será um tipo string.
        - Observar imagem modelo_logico2.png. Exemplo de um banco de dados relacionais, temos a definição de uma tabela - Produto e tipo de produto
        ...
        - Observar imagem modelo_logico3.png. Basicamente temos a definição dos nomes de tabela, suas colunas e definição das chaves de cada tabela.
...
Modelo Físico
    ...
    - Exemplos:
        - Observar imagem modelo_fisico1.png -> Nessa imagem temos uma preparação para a implementação, essa tabela servirá de cadastro para o cliente.
        - Observar imagem modelo_fisico2.png -> Utilizando a linguagem SQL, utilizaa-se essa forma para a criação de tabelas e dados.
...
- Outros conceitos essenciais:
    ...
    Ex: Aluno, carros, produto, vendedor, venda, etc. Observar imagem modelo_logico2.pgn -> Para essa tabela, tem-se duas entidades:
    Produto e Tipo de produto. Ou seja são as tabelas

    - Atributo: Propriedade ou caracteristica que descreve uma entidade. São as colunas (campos) das tabelas que irão armazenar os dados.
    Entidade Produto: código, descrição e preço
    Entidade Tipo de Produto: código, descrição.
    Uma entidade deve ter atributos. Para a imagem modelo_logico2.png temos os atributos: preço, descrição e codigo para a entidade Produto e descrição 
    e codigo para a entidade Tipo de Produto.

    - Atributo chave: Também conhecido como chave primaria, primary key ou pk. É um campo que deve possuir valor unico em todo o conjunto de dados da entidade.
    Esse atributo é usado para identificar unicamente um registro da tabela
    Para a imagem modelo_logico2.png o Atributo chave é código para ambas entidades.

    - Relacionamentos: Geralmente as entidades nunca estão sozinhas. Normalmente estão associadas com outras entidades.
    Ou seja uma tabela está associada, mantém relaciomaneto com outra tabela. Reconhecer e registrar os relacionamentos entre entidades fornece 
    ...
    Para a imagem modelo_logico2.png temos um relacionamento entre a entidade produto e tipo de produto.
    Isso indica que um produto tem um tipo.

    - Chave estrangeira: Tambem conhecida como foreign key ou fk.
    ...
    entidade.
    Para a imagem modelo_logico2.png temos que a entidade produto teria um atributo que seria a representação de uma outra
    entidade nela. Neste caso a outra entidade é tipo de produto.

    - Grau de relacionamento: Indica a quantida de entidades ligadas a um relacionamento.
    Os principais graus de relacionamento são: Unario, binario e ternario.
        - Unario:
        Observar foto unario.png. NEssa foto temos dois exemplos de um relacionamento unario, também chamado de grau 1.
        ...
        - Binario: 
        Observar foto binario.pgn. Nessa foto temos dois exemplos. Uma entidade se relaciona com outra entidade. Chamado tambem de grau 2.
        ...
        -Ternario:
            Também chamado de grau 3: Tres entidades estão relacionadads por um mesmo relacionamento. Observar foto ternario.png
            Temos um pedido relacionado com 3, existe uma entidade cliente, tipo de pagamento e vendedor, existe um relacionamento pedido, as tres entidades 
            estão relacionadas na mesma relação.
    ...
    Cardinalidade (Máxima):
        ...
        Exemplo: Um vendedor pode vender apenas um tipo de produto? ou dois? ou tres?
        Um produto pode ser vendido por apenas um vendedor? ou por todos?
        
        Relacionamento Binario Um para um (1:1):
            - Observar imagem um_para_um.png.
        ...
        Relacionamento Binario Um - Para - Muitos (1:n)
            - Observar imagem um_para_muitos.png.
        ...
        Relacionamento Binario Muitos - para Muitos (n:m):
            ...
            - Observar imagem muitos_para_muitos.png
    ...
    Cardinalidade (Minima):
        ...
        Exemplo : Observar a imagem minimo_zero_maximo_um.png. Um vendedor ocupa um unico escritorio, porém é obrigatorio que ele tenha um escritorio,
    ...
    Formas de Representação:
        ...
        Clássico -> observar imagem um_varios.png, tem-se o relacionamento incluindo a cardinalidade, o 1 indica um e um. Para o lado do cliente, temos um e 
        muitos.

        Pé de galinha -> Observar a imagem pe_de_galinha.png, é chamada de pé de galinha por causa dos simbolos, na representação tem-se o mesmo significado do classico acima
